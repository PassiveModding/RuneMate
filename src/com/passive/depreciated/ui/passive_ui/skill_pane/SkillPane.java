package com.passive.depreciated.ui.passive_ui.skill_pane;

import com.passive.api.bot.PassiveBot;
import com.passive.api.bot.trackers.skilltracker.SkillEventListener;
import com.passive.api.bot.trackers.skilltracker.SkillTracker;
import com.passive.api.ui.javafx.JavaFX;
import com.passive.depreciated.ui.passive_ui.skill_pane.tabs.SkillTab;
...
public class SkillPane extends TitledPane implements Initializable, SkillEventListener {
    ...
    public SkillPane(PassiveBot bot) {
        this.bot = bot;
        bot.getSkillTracker().addListener(this);
        JavaFX.loadFxml(bot, "com/passive/depreciated/ui/passive_ui/skill_pane/skill_pane.fxml", this, this);
    }

    @Override
    public void initialize(URL location, ResourceBundle resources) {
        try {
            setGraphic(new ImageView(new Image(bot.getPlatform().invokeLater(() -> Resources.getAsStream("com/passive/depreciated/ui/images/skills-icon-30x30.png")).get())));
