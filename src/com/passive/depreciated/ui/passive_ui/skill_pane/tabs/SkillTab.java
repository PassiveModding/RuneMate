package com.passive.depreciated.ui.passive_ui.skill_pane.tabs;

import com.passive.api.bot.PassiveBot;
import com.passive.api.bot.trackers.skilltracker.SkillTracker;
import com.passive.depreciated.ui.Formatting;
...
public class SkillTab extends TitledPane implements Initializable {
    ...
    public SkillTab(PassiveBot bot, SkillTracker.SkillInfo info) {
        this.bot = bot;
        this.info = info;
        JavaFX.loadFxml(bot, "com/passive/depreciated/ui/passive_ui/skill_pane/tabs/skill_tab.fxml", this, this);
    }
