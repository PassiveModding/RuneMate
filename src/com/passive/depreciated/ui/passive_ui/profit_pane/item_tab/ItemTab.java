package com.passive.depreciated.ui.passive_ui.profit_pane.item_tab;
...
public class ItemTab extends TitledPane implements Initializable {
    ...
    public ItemTab(PassiveBot bot, ProfitTracker.ItemInfo info) {
        this.bot = bot;
        this.info = info;
        JavaFX.loadFxml(bot, "com/passive/depreciated/ui/passive_ui/profit_pane/item_tab/item_tab.fxml", this, this);
    }
