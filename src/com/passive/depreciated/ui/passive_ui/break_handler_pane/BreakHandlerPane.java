package com.passive.depreciated.ui.passive_ui.break_handler_pane;

import com.passive.api.bot.PassiveBot;
import com.passive.api.bot.break_handler.Break;
import com.passive.api.bot.break_handler.BreakProfile;
...
public class BreakHandlerPane extends TitledPane implements Initializable {
    ...
    public BreakHandlerPane(PassiveBot bot) {
        this.bot = bot;
        JavaFX.loadFxml(bot, "com/passive/depreciated/ui/passive_ui/break_handler_pane/break_handler_pane.fxml", this, this);
    }

    @Override
    public void initialize(URL location, ResourceBundle resources) {
        Future<InputStream> stream = bot.getPlatform().invokeLater(() -> Resources.getAsStream("com/passive/depreciated/ui/images/break-handler-icon-30x30.png"));
