...
public class TutorialIsland extends LoopingBot {
    ...
    private Stage getCurrentStage(){
        ...
        if (g != null) {
            ...
            } else if (name == "Lumbridge Guide" || (ChatDialog.getText() != null && ChatDialog.getTitle() != null && ChatDialog.getTitle().startsWith("Lumbridge Guide")) || (ChatDialog.getText() != null && ChatDialog.getText().startsWith("If you have a question or"))){
                com.runemate.game.api.hybrid.RuneScape.logout();
